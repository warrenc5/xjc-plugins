...
public class ImplementsInterfacePlugin extends Plugin {
    ...
    public String getUsage() {
        return "  -Xii      :  make an interface for each class";
    }
    ...
    public boolean run(Outline otln, Options optns, ErrorHandler eh) throws SAXException {
        ...
        for (ClassOutline c : otln.getClasses()) {
            ...
            try {
                ...
                Logger.getLogger(ImplementsInterfacePlugin.class.getName()).log(Level.SEVERE, null, ex);
            }
            System.out.println("----------------------------------");
